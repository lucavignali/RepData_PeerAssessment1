...
Finally the maximum number of steps made in 5 minutes period is equal to `r Max_Step$step` and occurred on the `r Max_Step$date` at time interval `r Max_Step$interval`, corresponding to the red point in the previous figure.
